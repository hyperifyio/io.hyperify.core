...
import { BackgroundDTO, explainBackgroundDTOOrUndefined, isBackgroundDTOOrUndefined } from "../background/BackgroundDTO";
import { BorderDTO, explainMultiBorderDTOOrUndefined, isMultiBorderDTOOrUndefined } from "../border/BorderDTO";
import { ColorDTO, explainColorDTOOrUndefined, isColorDTOOrUndefined } from "../color/ColorDTO";
import { explainFontDTOOrUndefined, FontDTO, isFontDTOOrUndefined } from "../font/FontDTO";
...
export function createStyleDTO (
    ...
    margin          : SizeDTO | SizeBoxDTO | undefined,
    padding         : SizeDTO | SizeBoxDTO | undefined,
