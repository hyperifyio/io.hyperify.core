...
import { HeadingEntity } from "../../components/heading/HeadingEntity";
...
describe('ComponentEntity', () => {
    ...
    describe('isComponentDTO', () => {

        it('can test a complex DTO', () => {

            const dto : ComponentDTO = {
                "name" : "DraftSection",
                "extend" : "ArticleComponent",
                "style" : {
                    "width" : { "value" : 100, "unit" : UnitType.PERCENT },
                    "margin" : { "value" : 10, "unit" : UnitType.PX },
                    "padding" : { "value" : 10, "unit" : UnitType.PX },
                ...
                "content" : [
                    {
                        "name" : "DraftHeading",
                        "extend" : "HeadingComponent",
                        "content" : [
                            "Keskeneräiset tilaukset",
                        ],
                    },
                    {
                        "name" : "DraftTable",
            ...
            expect( isComponentDTO(dto) ).toBe(true);
        });
    ...
    describe('static methods', () => {
        ...
        describe('#isDTO', () => {
            ...
            it('can test a complex DTO', () => {
                    ...
                    "content" : [
                        {
                            "name" : "DraftHeading",
                            "extend" : "HeadingComponent",
                            "content" : [ "Keskeneräiset tilaukset",
                            ],
                        },
                        {
                            "name" : "DraftTable",
                ...
                expect( ComponentEntity.isDTO(dto) ).toBe(true);
            });
    ...
    describe('name property methods', () => {
    ...
    describe('content property methods', () => {
        ...
        describe('.getContentDTO', () => {
            ...
            beforeEach(() => {
                ...
                dto = HeadingEntity.createText('DraftHeading', 'Keskeneräiset tilaukset').getDTO();

                entity = (
                    ComponentEntity.create('Foo')
                                   .addContent('hello')
                                   .addContent(dto)
                );
            });
            ...
            it('can get the content with DTO', () => {
                expect( entity.getContentDTO() ).toEqual(
                    expect.arrayContaining([
                        dto
                    ])
        ...
        describe('.add', () => {
            ...
            it('can add more content using a DTO', () => {
                const dto = HeadingEntity.createText('DraftHeading', 'Keskeneräiset tilaukset').getDTO();
                entity.addContent( dto );
                const result = entity.getContentDTO();
    ...
    describe('extend property methods', () => {
    ...
    describe('meta property methods', () => {
