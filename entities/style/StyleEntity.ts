...
export const StyleEntityFactory = (
    EntityFactoryImpl.create<StyleDTO, Style>('Style')
                     ...
                     .add( EntityPropertyImpl.create("margin").setTypes(SizeEntity, SizeBoxEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("padding").setTypes(SizeEntity, SizeBoxEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("border").setTypes(BorderEntity, BorderBoxEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("font").setTypes(FontEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("textDecoration").setTypes(TextDecorationEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("background").setTypes(BackgroundEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("minWidth").setTypes(SizeEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("minHeight").setTypes(SizeEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("maxWidth").setTypes(SizeEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("maxHeight").setTypes(SizeEntity, VariableType.UNDEFINED) )
                     .add( EntityPropertyImpl.create("boxSizing").setTypes(BoxSizing, VariableType.UNDEFINED) )
);
