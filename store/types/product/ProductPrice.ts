...
export function createProductPrice (
    ...
    return {
        ...
        ...(discountFrom === undefined ? {} : { discountFrom }),
        ...(discountTo === undefined ? {} : { discountTo }),
        ...(buyUrl === undefined ? {} : { buyUrl }),
        ...(id === undefined ? {} : { id }),
        ...(stockSold === undefined ? {} : { stockSold }),
        ...(stockAmount === undefined ? {} : { stockAmount }),
        ...(stockEnabled === undefined ? {} : { stockEnabled }),
        ...(onHold === undefined ? {} : { onHold }),
        ...(published === undefined ? {} : { published }),
        ...(expenseSum === undefined ? {} : { expenseSum }),
    };
}
